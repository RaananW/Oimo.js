...
OIMO.Body.prototype = Object.create(OIMO.Shell.prototype);
OIMO.Body.prototype.constructor = OIMO.Body;

OIMO.Body.prototype.awake = function(){
	this.sleeping = false;
	this.emit("awake");
	return this;
};
OIMO.Body.prototype.sleep = function(){
	this.sleeping = true;
...
OIMO.Body.prototype.dispose = function(){
	this.world.removeBody(this);
	return this;
};
OIMO.Body.prototype.intersectTest = function(type, shape){
	switch(type){
...
OIMO.Body.prototype.computeBounds = function(){
...
OIMO.Body.prototype.applyForce = function(f, p){
...
OIMO.Body.prototype.applyCentralForce = function(f){
	this.applyForce(f, _body_applyCentralForce_v1);
	return this;
};
OIMO.Body.prototype.updateInertiaWorld = function(override){
...
OIMO.Body.prototype.integrate = function(dt){
...
OIMO.Body.prototype.updateShape = function(){
	var sh = this.shape;
...
OIMO.Body.prototype.updateMassDetails = function(){
	var I = this.inertia;
